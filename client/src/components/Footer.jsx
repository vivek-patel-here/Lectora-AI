...
function Footer() {
  return (
    <div className="h-fit w-screen flex flex-col items-center justify-center gap-4 bg-blue-900 p-4">
      <div className="w-8/10 h-fit flex items-center flex-wrap justify-between">
        <div className="h-full w-full lg:w-3/10 p-4">
          <div className="flex items-center w-full gap-5">
            <img src="/Logo.PNG" alt="Lectora-ai" className="h-15 w-15 rounded-full"/>
            <h1 className="text-white text-2xl font-semibold">Lectora AI</h1>
          </div>
      ...
      <div className="flex items-center justify-between  w-8/10 h-3/10 border-t-1 border-white "></div>
      <p className="w-full h-1/4 grid place-content-center text-white">
